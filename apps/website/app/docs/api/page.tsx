...
export const metadata: Metadata = {
  title: "API Reference | Kazama",
  description: "Complete API reference for kazama",
}
    ...
    <div className="max-w-4xl mx-auto py-10 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-10">
        ...
        <p className="text-lg text-muted max-w-2xl leading-relaxed">
          Every function, hook, configuration object, and default. The complete technical reference for <code className="text-sm bg-surface px-1.5 py-0.5 rounded-md text-fg">kazama</code>.
        </p>
      </div>
