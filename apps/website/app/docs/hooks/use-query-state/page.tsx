...
const basicCode = `import { useQueryState, parseAsInteger } from 'musubi';
...
const batchingCode = `import { useQueryState, parseAsString, parseAsInteger } from 'musubi';
    ...
    >
      <div className="flex flex-col gap-12 text-fg">
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted leading-relaxed">
            If you have multiple components updating different query parameters at the same time, updating the <code>window.history</code> sequentially would cause race conditions. <code>musubi</code> intelligently batches synchronous updates together into a single history transition.
          </p>
          <div className="overflow-hidden rounded-[var(--musubi-radius)] border border-line bg-base">
