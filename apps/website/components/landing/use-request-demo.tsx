...
export function UseRequestDemoUI() {
  ...
  const handleRequest = () => {
    setLoading(true)
    setTimeout(() => {
      setData({ id: 42, title: 'Learn Kizuna', completed: false })
      setLoading(false)
    }, 1000)
  }

  return (
    <div className="flex flex-col text-left bg-base border border-line rounded-[var(--kizuna-radius)] overflow-hidden w-full shadow-sm">
