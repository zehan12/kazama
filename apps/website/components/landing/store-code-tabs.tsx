...
export function StoreCodeTabs({ storeTab, appTab }: StoreCodeTabsProps) {
  ...
  return (
    <div className="w-full overflow-hidden border border-line/40 bg-[#0d0d0d] rounded-xl relative mt-2 flex flex-col">
      <div className="flex items-center gap-4 px-4 pt-3 pb-0 border-b border-line/20 bg-surface/50">
        <button
