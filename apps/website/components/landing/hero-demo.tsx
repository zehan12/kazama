  ...
  return (
    <>
      <div className="flex flex-wrap items-center gap-3 mb-12">
        ...
        <Link
          href="/docs"
          className="inline-flex h-11 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-[var(--musubi-radius)] px-5 text-sm font-medium text-muted transition-colors hover:text-fg"
      ...
      <div className={cn(
        'flex flex-col bg-surface border border-line rounded-[var(--musubi-radius)]',
