  ...
  function Button({ variant = 'primary', size = 'md', className, children, ...props }, ref) {
    return (
      <button
        ref={ref}
        className={cn(
          'inline-flex items-center justify-center gap-2 font-medium transition-colors cursor-pointer select-none whitespace-nowrap shrink-0 disabled:pointer-events-none disabled:opacity-40 rounded-[var(--kazama-radius)]',
